...
public static class TiglFactionParser
{
    public static TiglFactionName ParseFaction(string faction)
    {
        return faction switch
        {
            ...
            "The Crimson Rebellion" => TiglFactionName.TheCrimsonRebellion,
            "The Deepwrought Scholarate" => TiglFactionName.TheDeepwroughtScholarate,
            "The Firmament" => TiglFactionName.TheFirmamentTheObsidian,
            "The Obsidian" => TiglFactionName.TheFirmamentTheObsidian,
            "Last Bastion" => TiglFactionName.LastBastion,
            "The Ral Nel Consortium" => TiglFactionName.TheRalNelConsortium,

            "The Ruby Monarch" => TiglFactionName.TheRubyMonarch,
            "Radiant Aur" => TiglFactionName.RadiantAur,
            "Avarice Rex" => TiglFactionName.AvariceRex,
            "Il Sai Lakoe, Herald of Thorns" => TiglFactionName.IlSaiLakoeHeraldOfThorns,
            "The Saint of Swords" => TiglFactionName.TheSaintOfSwords,
            "Il Na Viroset" => TiglFactionName.IlNaViroset,
            "El Nen Janovet" => TiglFactionName.ElNenJanovet,
            "A Sickening Lurch" => TiglFactionName.ASickeningLurch,
            ...
            "Uydai Conclave" => TiglFactionName.UydaiConclave,
            "Pharadn Order" => TiglFactionName.PharadnOrder,
            "Qhet Republic" => TiglFactionName.QhetRepublic,
            "Atokera Legacy" => TiglFactionName.AtokeraLegacy,
            "Belkosea Allied States" => TiglFactionName.BelkoseaAlliedStates,
            "Toldar Concordat" => TiglFactionName.ToldarConcordat,

            "Franken" => TiglFactionName.Franken,
            "Franken 1" => TiglFactionName.Franken,
            "Franken 2" => TiglFactionName.Franken,
            "Franken 3" => TiglFactionName.Franken,
            "Franken 4" => TiglFactionName.Franken,
            "Franken 5" => TiglFactionName.Franken,
            "Franken 6" => TiglFactionName.Franken,
            "Franken 7" => TiglFactionName.Franken,
            "Franken 8" => TiglFactionName.Franken,
            "Franken 9" => TiglFactionName.Franken,
            "Franken 10" => TiglFactionName.Franken,
            "Franken 11" => TiglFactionName.Franken,
            "Franken 12" => TiglFactionName.Franken,
            "Franken 13" => TiglFactionName.Franken,
            "Franken 14" => TiglFactionName.Franken,
            "Franken 15" => TiglFactionName.Franken,
            "Franken 16" => TiglFactionName.Franken,
            "Franken 17" => TiglFactionName.Franken,
            "Franken 18" => TiglFactionName.Franken,
            "Franken 19" => TiglFactionName.Franken,
            "Franken 20" => TiglFactionName.Franken,
            "Franken 21" => TiglFactionName.Franken,
            "Franken 22" => TiglFactionName.Franken,
            "Franken 23" => TiglFactionName.Franken,
            "Franken 24" => TiglFactionName.Franken,
            "Franken 25" => TiglFactionName.Franken,
            "Franken 26" => TiglFactionName.Franken,
