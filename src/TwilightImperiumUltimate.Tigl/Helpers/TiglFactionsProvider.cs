...
public static class TiglFactionsProvider
{
    ...
    [
        ...
        TiglFactionName.TheCeldauriTradeConfederation,
        TiglFactionName.TheCheiranHordes,
        TiglFactionName.TheDihMohnFlotilla,
        TiglFactionName.TheEdynMandate,
        TiglFactionName.TheFlorzenProfiteers,
        TiglFactionName.TheFreeSystemsCompact,
        TiglFactionName.TheGheminaRaiders,
        TiglFactionName.TheGhotiWayfarers,
        TiglFactionName.TheGledgeUnion,
        TiglFactionName.TheGlimmerOfMortheus,
        TiglFactionName.TheKolleccSociety,
        TiglFactionName.TheKortaliTribunal,
        TiglFactionName.TheKyroSodality,
        TiglFactionName.TheLanefirRemnants,
        TiglFactionName.TheLiZhoDynasty,
        TiglFactionName.TheLTokkKhrask,
        TiglFactionName.TheMirvedaProtectorate,
        TiglFactionName.TheMonksOfKolume,
        TiglFactionName.TheMykoMentori,
        TiglFactionName.TheNivynStarKings,
        TiglFactionName.TheNokarSellships,
        TiglFactionName.TheOlradinLeague,
        TiglFactionName.RohDhnaMechatronics,
        TiglFactionName.TheSavagesOfCymiae,
        TiglFactionName.TheShipwrightsofAxis,
        TiglFactionName.TheTnelisSyndicate,
        TiglFactionName.TheVadenBankingClans,
        TiglFactionName.TheVaylerianScourge,
        TiglFactionName.TheVeldyrSovereignty,
        TiglFactionName.TheZealotsOfRhodun,
        TiglFactionName.TheZelianPurifier,

        TiglFactionName.UydaiConclave,
        TiglFactionName.PharadnOrder,
        TiglFactionName.QhetRepublic,
        TiglFactionName.AtokeraLegacy,
        TiglFactionName.BelkoseaAlliedStates,
        TiglFactionName.ToldarConcordat,
    ];
}
