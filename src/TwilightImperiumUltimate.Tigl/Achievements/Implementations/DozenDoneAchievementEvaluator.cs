...
/// <summary>
/// Win a game to 12 VPs.
/// </summary>
[AchievementEvaluator(AchievementName.DozenDone)]
public sealed class DozenDoneAchievementEvaluator(
    IAchievementRepository achievementRepository)
    : IAchievementEvaluator
{
    private const int VictoryPointsToWin = 12;
