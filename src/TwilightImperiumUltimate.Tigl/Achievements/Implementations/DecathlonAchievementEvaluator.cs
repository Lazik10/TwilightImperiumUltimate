...
/// <summary>
/// Win a game to 10 VPs.
/// </summary>
[AchievementEvaluator(AchievementName.Decathlon)]
public sealed class DecathlonAchievementEvaluator(
    IAchievementRepository achievementRepository)
    : IAchievementEvaluator
{
    private const int VictoryPointsToWin = 10;
