...
/// <summary>
/// Earn 15 different achievements.
/// </summary>
[AchievementSummaryEvaluator(AchievementName.Overachiever)]
public sealed class OverachieverAchievementEvaluator(
    IAchievementRepository achievementRepository)
    : IAchievementEvaluator
{
    private const int MinAchievementsEarned = 15;
