...
/// <summary>
/// Earn 30 different achievements.
/// </summary>
[AchievementSummaryEvaluator(AchievementName.Completionist)]
public sealed class CompletionistAchievementEvaluator(
        IAchievementRepository achievementRepository)
    : IAchievementEvaluator
{
    private const int MinAchievementsEarned = 30;
