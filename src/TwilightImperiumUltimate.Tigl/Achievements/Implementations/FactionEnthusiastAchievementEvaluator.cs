...
/// </summary>
[AchievementEvaluator(AchievementName.FactionEnthusiast)]
public sealed class FactionEnthusiastAchievementEvaluator(
    IAchievementRepository achievementRepository)
    : IAchievementEvaluator
{
    private const int MinWinsWithFaction = 10;
