...
internal class MediumSixPlayersMapBuilder : BaseMapBuilder
{
    private static readonly Random Random = new();

    public MediumSixPlayersMapBuilder(ISystemTileRepository systemTileRepository)
    ...
    {
        var homeSpots = new[] { 3, 7, 13, 28, 34, 45 };
