...
namespace TwilightImperiumUltimate.Draft.Draft.MapDraft.MapBuilders.SixPlayers;

internal class LargeMapSixPlayersMapBuilder : BaseMapBuilder
{
    private static readonly Random Random = new();

    public LargeMapSixPlayersMapBuilder(ISystemTileRepository systemTileRepository)
    ...
    {
        var homeSpots = new[] { 4, 26, 62, 76, 54, 18 };
