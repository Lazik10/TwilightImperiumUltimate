...
internal class SmallMapAlternateThreePlayersMapBuilder : BaseMapBuilder
{
    private static readonly Random Random = new();

    public SmallMapAlternateThreePlayersMapBuilder(ISystemTileRepository systemTileRepository)
