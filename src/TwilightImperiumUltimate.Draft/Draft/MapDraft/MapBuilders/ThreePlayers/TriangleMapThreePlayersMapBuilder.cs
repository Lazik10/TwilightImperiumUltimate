...
internal class TriangleMapThreePlayersMapBuilder : BaseMapBuilder
{
    private static readonly Random Random = new();

    public TriangleMapThreePlayersMapBuilder(ISystemTileRepository systemTileRepository)
    ...
    {
        var emptySpots = new[] { 0, 1, 5, 6, 7, 8, 12, 13, 14, 20, 35, 37, 39, 41 };
