...
internal class TriangleNarrowMapThreePlayersMapBuilder : BaseMapBuilder
{
    private static readonly Random Random = new();

    public TriangleNarrowMapThreePlayersMapBuilder(ISystemTileRepository systemTileRepository)
