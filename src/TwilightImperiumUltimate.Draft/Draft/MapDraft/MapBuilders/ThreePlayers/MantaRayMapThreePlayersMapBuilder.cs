...
internal class MantaRayMapThreePlayersMapBuilder : BaseMapBuilder
{
    private static readonly Random Random = new();

    public MantaRayMapThreePlayersMapBuilder(ISystemTileRepository systemTileRepository)
