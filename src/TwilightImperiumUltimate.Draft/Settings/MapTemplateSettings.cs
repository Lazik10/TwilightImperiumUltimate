namespace TwilightImperiumUltimate.Draft.Settings;

public static class MapTemplateSettings
{
    ...
    public static readonly int MaxTilePositionsTriangleNarrowMap = 36;
