...
internal class SpecificMapSettingsProvider : ISpecificMapSettingProvider
{
    public Task<IMapSettings> GetMapSettingsForSpecificTemplate(MapTemplate mapTemplate)
    {
        IMapSettings mapSettings = mapTemplate switch
        {
            ...
            MapTemplate.ThreePlayersMediumHyperlineMap => new ThreePlayersMediumHyperlineMapSettings(),
            ...
            MapTemplate.ThreePlayersMediumTridentMap => new ThreePlayersMediumTridentMapSettings(),
            MapTemplate.ThreePlayersMediumRexMap => new ThreePlayersMediumRexMapSettings(),
            ...
            MapTemplate.FourPlayersMediumHyperlineMap => new FourPlayersMediumHyperlineMapSettings(),
