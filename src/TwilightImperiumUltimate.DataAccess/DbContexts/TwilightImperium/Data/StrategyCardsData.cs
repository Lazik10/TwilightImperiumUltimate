...
internal static class StrategyCardsData
{
    internal static List<StrategyCard> StrategyCards => new List<StrategyCard>
    {
        ...
        new() { Id = 6, EnumName = StrategyCardName.Warfare, InitiativeOrder = InitiativeOrder.Sixth, GameVersion = GameVersion.BaseGame },
        ...
        new() { Id = 10, EnumName = StrategyCardName.ConstructionProphecyOfKings, InitiativeOrder = InitiativeOrder.Fourth, GameVersion = GameVersion.ProphecyOfKings },
    };
}
