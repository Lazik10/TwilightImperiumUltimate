...
public class MapDataProvider : IMapDataProvider
{
    public IMapData GetMapData(MapTemplate mapTemplate)
    {
        return mapTemplate switch
        {
            ...
            MapTemplate.ThreePlayersMediumHyperlineMap => new ThreePlayersMediumHyperlineMapData(),
            ...
            MapTemplate.FourPlayersMediumHyperlineMap => new FourPlayersMediumHyperlineMapData(),
            ...
            MapTemplate.FivePlayersMediumHyperlineMap => new FivePlayersMediumHyperlineMapData(),
